  ...
  <div class="course-wrap">
    <div class="crumbs">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item>
          <i class="el-icon-fa fa-book"></i> 开课管理
        </el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    ...
    <div class="container">
      ...
      <div class="table">
        <el-table :data="tableData" stripe>
          <el-table-column label="开课Id" prop="id" />
          <el-table-column label="开课学期" prop="term" width="150px"/>
          <el-table-column label="课程名" prop="courseName" width="100px" />
          <el-table-column label="教师" prop="teacherName" />
          <el-table-column label="所属学院" prop="departmentName" width="100px"/>
      ...
      <el-dialog :visible.sync="editing" title="编辑" width="30%">
        <el-form :model="entityForm" label-width="70px" ref="form">
          <el-form-item label="开课学期">
            <el-input v-model="entityForm.term"></el-input>
          </el-form-item>
            <el-form-item label="开办课程">
                <el-select placeholder="请选择课程" v-model="entityForm.courseId">
                    <el-option
                            :key="index"
                            :label="item.name"
                            :value="item.id"
